...
public interface subProblemClient {
    ...
    @GetMapping(value = "v1/sub-problem/list/{code}/all", produces = {"application/json"})
    ...
    @ApiOperation(value =  "code가 일치하는 sub-problem을 paging 조회", produces = "http")
    ResponseEntity getSubProblemByCodePaging(@PathVariable("code") String code, Pageable pageable);
